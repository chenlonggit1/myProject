...
cc.Class({
    ...
    onLoad: function () {
        ...
        this.toggleNormalTexture = [];
        this.toggleNormalTexture[0] = this.node.getChildByName("dikuang").getChildByName("top").getChildByName("ToggleContainer").getChildByName("toggle1").getChildByName("texture")
        this.toggleNormalTexture[1] = this.node.getChildByName("dikuang").getChildByName("top").getChildByName("ToggleContainer").getChildByName("toggle2").getChildByName("texture")
        this.toggleNormalTexture[2] = this.node.getChildByName("dikuang").getChildByName("top").getChildByName("ToggleContainer").getChildByName("toggle3").getChildByName("texture")

        this.toggleLightTexture = [];
        this.toggleLightTexture[0] = this.node.getChildByName("dikuang").getChildByName("top").getChildByName("ToggleContainer").getChildByName("toggle1").getChildByName("light")
        this.toggleLightTexture[1] = this.node.getChildByName("dikuang").getChildByName("top").getChildByName("ToggleContainer").getChildByName("toggle2").getChildByName("light")
        this.toggleLightTexture[2] = this.node.getChildByName("dikuang").getChildByName("top").getChildByName("ToggleContainer").getChildByName("toggle3").getChildByName("light")
    ...
    setRuleBtnStatu: function () {
        for (let index = 0; index < this.toggleNormalTexture.length; index++) {
            this.toggleNormalTexture[index].active = !(this.isGermRate == index);
            this.toggleLightTexture[index].active = (this.isGermRate == index);
        }
