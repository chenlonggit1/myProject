...
cc.Class({
    ...
    onLoad: function () {
        ...
        //声音
        this.voiceBtn = this.node.getChildByName("voice");
        ...
        //小丑模式总结算提示
        this.jokerFloatTips = this.node.getChildByName("jokerLayer").getChildByName("jokerFloatTips");
        this.jokerFloatTipsAmount = this.jokerFloatTips.getChildByName("Layout").getChildByName("Amount").getComponent(cc.Label);
    ...
    setVoice: function () {
        if (this.voiceOn == null) {
            this.voiceOn = this.voiceBtn.getChildByName("on");
        }
        if (this.voiceOff == null) {
            this.voiceOff = this.voiceBtn.getChildByName("off");
        }
    ...
    //重回游戏时展示小丑结算
    showJokerTotalRewardWhileBackGame: function (amount) {
        this.jokerFloatTipsAmount.string = amount.toString();
        this.jokerFloatTips.setScale(1);
        this.jokerFloatTips.active = true;
        this.jokerFloatTips.runAction(cc.sequence(cc.scaleTo(0.15, 1.5),
            cc.scaleTo(0.15, 1),
            cc.delayTime(2),
            cc.callFunc(function () {
                this.jokerFloatTips.active = false;
            }.bind(this))));
    },
