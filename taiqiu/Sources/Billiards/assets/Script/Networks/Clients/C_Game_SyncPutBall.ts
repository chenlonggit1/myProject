...
export class C_Game_SyncPutBall
{
    /**
     * 
     * @param pos 
     ...
     */
    public static Send(pos:cc.Vec3,dropStatus:number,angle:cc.Quat,body:cc.Vec3)
    {
        ...
        ClientManager.SendMessage(ClientNames.Lobby, bytes, PacketID.SYNC_PUT_BALL);
    }
}
