...
import { WXPlantformBinder } from "./WXPlantformBinder";


/**
*@description:微信公众关注引导
**/
export class WXPlantformModule extends ModuleBasePopup 
{
	public static ClassName:string = "WXPlantformModule";
	public get assets():any[]{return ["Pay/WXPlantform/WXPlantform"]};
	public constructor()
	{
		super();
	...
	{
		super.createViews();
		this.binder = new WXPlantformBinder();
	}
