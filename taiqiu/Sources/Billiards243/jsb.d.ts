declare namespace jsb {
    function saveImageData(data: Uint8Array, width: number, height: number, filePath: string): boolean;

    module fileUtils {
        export function purgeCachedEntries(): void;
        export function getStringFromFile(filename: string): string;
        export function getDataFromFile(filename: string): Uint8Array;
        export function getFileDataFromZip(zipFilePath: string, filename: string, size: number): Uint8Array;
        ...
        export function setWritablePath(writablePath: string);

        export function writeStringToFile(dataStr: string, fullPath: string): boolean;
        export function writeDataToFile(Object: any, fullPath: string): boolean;
         ...
         *  @lua NA
         */
        export function setSearchPaths(searchPaths: string[]);
        /**
         * Set default resource root path.
         */
        export function setDefaultResourceRootPath(path: string);
        /**
         * Add search path.
         *
         * @since v2.1
         */
        export function addSearchPath(path: string, front = false);
        /**
         ...
         */
        export function renameFile(path: string, oldname: string, name: string): boolean;
